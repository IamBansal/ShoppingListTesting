...
class ShoppingItemAdapter @Inject constructor(
    ...
    override fun onBindViewHolder(holder: ShoppingItemViewHolder, position: Int) {
        ...
        holder.itemView.apply {
            ...
            this.findViewById<MaterialTextView>(R.id.tvName).text = shoppingItem.name
            val amountText = "${shoppingItem.amount}x"
            this.findViewById<MaterialTextView>(R.id.tvShoppingItemAmount).text = amountText
            val priceText = "${shoppingItem.price} Rs."
            this.findViewById<MaterialTextView>(R.id.tvShoppingItemPrice).text = priceText
        }
    }
}